    ...
    <div class="col-md-9">
        ...
        <div class="card-body">
                <form action="/user/destroy" method="post">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPos">Usia</label>
                        <input name="usia" type="text" class="form-control" id="exampleInputPos" aria-describedby="emailHelp" placeholder="Masukkan Usia" value="{{ $user->pos }}" readonly>
                    </div>
